...
import 'package:file_organizer_cli/src/command_runner.dart';
...
void main() {
  group('FileOrganizerCliCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late FileOrganizerCliCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = FileOrganizerCliCommandRunner(
        logger: logger,
    ...
    test('can be instantiated without an explicit analytics/logger instance',
        () {
      final commandRunner = FileOrganizerCliCommandRunner();
